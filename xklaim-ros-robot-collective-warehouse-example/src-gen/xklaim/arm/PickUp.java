      ...
      while (true) {
        {
          ...
          modelstate.pose.position.x = (((x).doubleValue() + 0.2) + offset);
          modelstate.pose.position.y = (((y).doubleValue() + 0.2) + offset);
          modelstate.model_name = id;
          modelstate.reference_frame = "world";
          Pose_item.publish(modelstate);
          InputOutput.<String>println((((((("### Item " + id) + " delivered at (") + Double.valueOf((((x).doubleValue() + 0.2) + offset))) + ",") + Double.valueOf((((y).doubleValue() + 0.2) + offset))) + ")"));
